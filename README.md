...
```javascript
import FLOAT32_LN_PI from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-ln-pi@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-ln-pi/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/constants-float32-ln-pi/actions/workflows/test.yml?query=branch:v0.1.0
